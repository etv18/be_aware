...
function renderDataTable(loan_payments){
    const tbody = document.getElementById('loan-payments-table-body-id');
    tbody.innerHTML = '';
    ...
    loan_payments.forEach(payment => {
        ...
        tableRow.innerHTML = `
            ...
            <td>${ payment.loan ? payment.loan.code : '-'}</td>
...
async function filterData(){
    ...
    renderDataTable(data.loan_payments);
