...
def filter_all():
    try:
        ...
        if start and end:
            ...
            and_filters.append(Deposit.created_at.between(start_date, end_date))
        ...
        deposits = (
            Deposit.query
            .outerjoin(Deposit.bank_account) #allows to show expense without a bank account        
        ...
        deposits_list = []
        for l in deposits:
            deposits_list.append(l.to_dict())
